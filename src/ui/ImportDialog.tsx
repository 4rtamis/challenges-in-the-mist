...
export default function ImportDialog({ open, onOpenChange }: Props) {
  ...
  function importFromFile() {
    ...
    try {
      const { challenge, warnings } = importFromTOMLWithWarnings(fileRawToml);
        ...
        <Tabs defaultValue="file" className="space-y-3">
          ...
          <TabsContent value="file" className="space-y-3">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Importing files can include malicious content. Only open TOML
          ...
          <TabsContent value="paste" className="space-y-3">
            <Alert variant="destructive">
              ...
              <AlertTitle>Import from trusted sources only</AlertTitle>
              <AlertDescription>
                Pasted TOML can include malicious payloads. Only paste content
                from creators you trust.
              </AlertDescription>
            </Alert>
    ...
    <div className="rounded-md border p-3 space-y-2">
      {name && (
        <div className="text-sm">
          <span className="font-medium">Detected challenge:</span> {name}
        </div>
      )}
      {warnings.length > 0 && (
