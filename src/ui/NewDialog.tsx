        ...
        >
            <DialogContent className="sm:max-w-[640px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Start fresh or load a sample to see what the editor can
                        do.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <label className="flex items-start gap-3 rounded-md border p-3 hover:bg-muted/40 cursor-pointer">
                        ...
                        <div className="grid gap-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                An empty sheet with no roles, limits, tags,
                                mights, or threats.
                            </p>
                        </div>
                    </label>
                        ...
                        <div className="grid gap-1 w-full">
                            ...
                            >
                                ...
                                <span className="font-medium">
                                    Lantern-Warden of the Wilds
                                </span>
                            </Label>
                            <p className="text-sm text-muted-foreground">
                                A wolf-spirit who guides beasts away from
                                hunters with a spectral lantern. Demonstrates
                                limits (incl. progress), tags & statuses (inline
                                tokens), three levels of Might, threats &
                                consequences (plus general ones), special
                                features, and meta.
                            </p>
                        </div>
                    </label>
